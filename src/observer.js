...
var Observer = (function() {
  ...
  function create(__verbose__=false, __effect__=false, __statistic__=false, __metahandler__=false, log, logc, trace, increment, initialize, self) {
    ...
    */
    ...
    function Membrane() {
      ...
      this.apply = function(target, thisArg, argumentsList) {
        ...
        return native ? target.apply(thisArg, argumentsList) : target.apply(thisArg, argumentsList);
      };
      ...
      this.construct = function(target, argumentsList) {
        ...
        var thisArg = native ? Object.create(target.prototype) : Object.create(target.prototype);
        var result =  native ? target.apply(thisArg, argumentsList) : target.apply(thisArg, argumentsList);
  ...
  // Realm constructor
  Package.export("create", create, Observer);
